...
const materialFaqs: Partial<Record<string, Record<Locale, MaterialFaqItem[]>>> = {
  ...
  leather: {
    en: [
      ...
      {
        question: "Why does the leather have an irregular shape and natural markings?",
        answer:
      ...
      {
        question: "What is the difference between Aniline, Semi-Aniline, and Pigmented leather?",
        answer:
    ...
    ja: [
      ...
      {
        question: "アニリン、セミアニリン、ピグメントレザーの違いは何ですか？",
        answer:
  ...
  "vegan-leather": {
    ...
    ja: [
      ...
      {
        question: "ビニール（PVC）、PU レザー、マイクロファイバーレザーの違いは何ですか？",
        answer:
  ...
  fabric: {
    en: [
      ...
      {
        question: "Will the pattern and texture of fabric match original classic interior?",
        answer:
    ...
    ja: [
      {
        question: "CAMARI ではどのような自動車用ファブリックを扱っていますか？",
        answer:
