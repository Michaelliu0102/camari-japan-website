...
ROOT = Path("/Users/michael/Documents/Website")
...
TITLE_FILL = PatternFill("solid", fgColor="163A5F")
    ...
    "product_types": [
        {
            ...
            "seo_image": "https://example.com/camari/alcantara/panel/hero.jpg",
        },
        {
            ...
            "seo_image": "https://example.com/camari/alcantara/cover/hero.jpg",
        },
    ],
    "product_type_specs": [
        {
    ...
    "skus": [
        {
            ...
            "hex": "#1B1B1D",
            "image": "https://example.com/camari/alcantara/panel/shadow-black-main.jpg",
            "swatch_image": "https://example.com/camari/alcantara/panel/shadow-black-swatch.jpg",
            ...
            "seo_image": "https://example.com/camari/alcantara/panel/shadow-black-main.jpg",
        },
        {
            ...
            "color_name_ja": "サドルタン",
            "hex": "#9B6A3C",
            "image": "https://example.com/camari/alcantara/cover/saddle-tan-main.jpg",
            "swatch_image": "https://example.com/camari/alcantara/cover/saddle-tan-swatch.jpg",
            ...
            "seo_image": "https://example.com/camari/alcantara/cover/saddle-tan-main.jpg",
        },
    ],
    "sku_specs": [
        {
    ...
    "sku_downloads": [
        {
            ...
            "href": "https://example.com/camari/downloads/alcantara-panel-shadow-black-tds.pdf",
            "type": "technical",
        },
        {
            "sku_slug": "c-alc-4991-shadow-black-panel",
            ...
            "href": "https://example.com/camari/downloads/alcantara-panel-care-guide.pdf",
            "type": "care",
        },
        {
            "sku_slug": "c-alc-6206-saddle-tan-cover",
            ...
            "href": "https://example.com/camari/downloads/alcantara-cover-saddle-tan-tds.pdf",
            "type": "technical",
        },
        {
            "sku_slug": "c-alc-6206-saddle-tan-cover",
            ...
            "href": "https://example.com/camari/downloads/alcantara-cover-program-catalog.pdf",
            "type": "catalog",
        },
    ],
    "sku_case_gallery": [
        {
            "sku_slug": "c-alc-4991-shadow-black-panel",
            "sort_order": 1,
            "image": "https://example.com/camari/cases/alcantara-panel-door-trim.jpg",
        ...
        },
        {
            "sku_slug": "c-alc-6206-saddle-tan-cover",
            "sort_order": 1,
            "image": "https://example.com/camari/cases/alcantara-cover-seat-center.jpg",
...
WIDTHS = {
    "product_types": [26, 18, 22, 20, 36, 28, 64, 38, 54],
    ...
    "skus": [30, 16, 24, 20, 22, 18, 12, 52, 52, 56, 34, 38, 30, 56, 34, 52],
    "sku_specs": [30, 12, 24, 18, 42, 28],
    "sku_downloads": [30, 12, 24, 20, 48, 30, 60, 14],
    "sku_case_gallery": [30, 12, 60, 42, 30],
}


NOTES = {
    "product_types": "每行代表一个产品类型，先放 Panel / Cover 两类，用于网站一级产品结构。",
    ...
    "skus": "每行代表一个色号或具体 SKU，分别挂到 Alcantara panel 与 Alcantara cover。",
    "sku_specs": "SKU 级规格覆盖，用于具体色号/品番差异化参数。",
    "sku_downloads": "资料类型仅支持 catalog / technical / care。",
    "sku_case_gallery": "案例图用于详情页底部图库，一行一张。",
}
